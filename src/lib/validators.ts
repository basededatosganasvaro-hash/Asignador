...
export const ROLES = ["admin", "gerente_regional", "gerente_sucursal", "supervisor", "promotor", "gestor_operaciones", "comercial", "direccion", "asesor_digital", "analista"] as const;
