...
/**
 * Wrapper que bloquea el contenido de WhatsApp Masivo si el usuario
 * no es beta tester. Reemplaza el contenido (no overlay).
 */
export function WhatsAppBetaBlock({ children }: { children: React.ReactNode }) {
  const { permitido, loading } = useWhatsAppBeta();
    ...
    return (
      <div className="flex justify-center items-center min-h-[60vh] px-4">
        <div className="relative max-w-md w-full">
          ...
          <div className="relative bg-surface rounded-2xl border border-emerald-500/20 p-8 text-center">
