...
import {
  ...
  Inbox, Scale, ArrowLeftRight, ChevronLeft, Menu, BarChart3, Search, History, Share2, ShieldAlert,
} from "lucide-react";
      ...
      <nav className={`flex-1 overflow-y-auto py-2 ${showLabels ? "px-2" : "px-1"}`}>
        {isOperaciones ? (
          ...
          <>
            ...
            <NavItem label="Auditoría" href="/admin/auditoria" icon={<ShieldAlert className="w-5 h-5" />} pathname={pathname} showLabels={showLabels} exact />
